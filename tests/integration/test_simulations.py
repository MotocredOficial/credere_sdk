...
def test_create_simulation(
    sync_client: CredereClient, simulation_data: SimulationData
) -> None:
...
def test_get_simulation(sync_client: CredereClient) -> None:
...
def test_list_simulations(sync_client: CredereClient) -> None:
